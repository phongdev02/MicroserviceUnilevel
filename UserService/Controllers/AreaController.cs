...
namespace UserService.Controllers
{
    ...
    public class AreaController : ControllerBase
    {
        ...
        [HttpPut("EditArea")]
        public async Task<IActionResult> EditArea(string code)
        {
            _responseDto = await _khuvuc.DeleteArea(code);
        ...
        {
            _responseDto.IsSuccess = a.Trim().ToLower().Equals(b.Trim().ToLower());
            _responseDto.Message = "a.Trim().ToLower().Equals(b.Trim().ToLower())";
            return Ok(_responseDto);
